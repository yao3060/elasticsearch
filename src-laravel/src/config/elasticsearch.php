...
return [
    ...
    'connections' => [
        ...
        'default' => [
            ...
            'hosts' => [
                [
                    'host'              => env('ELASTICSEARCH_HOST', '192.168.5.31'),
                    'port'              => env('ELASTICSEARCH_PORT', 9400),
        ...
        'color' => [
            'hosts' => [
                [
                    'host'              => env('ELASTICSEARCH_HOST', '192.168.4.211'),
                    'port'              => env('ELASTICSEARCH_PORT', 9400),
                    'scheme'            => env('ELASTICSEARCH_SCHEME', null),
                    'user'              => env('ELASTICSEARCH_USER', null),
                    'pass'              => env('ELASTICSEARCH_PASS', null),
        ...
        'keyword' => [
            'hosts' => [
                [
                    'host'              => env('ELASTICSEARCH_HOST', '192.168.5.32'),
                    'port'              => env('ELASTICSEARCH_PORT', 9400),
                    'scheme'            => env('ELASTICSEARCH_SCHEME', null),
                    'user'              => env('ELASTICSEARCH_USER', null),
                    'pass'              => env('ELASTICSEARCH_PASS', null),
