...
class DesignerRecommendAssetTag extends ActiveRecord {
    ...
    public function getAsset() {
        return $this->hasMany(DesignerRecommendAssetTagLink::className(), ['tag_id' => 'id']);
    }

    //    非vip图片
    public function getAssetv2() {
        return $this->hasMany(DesignerRecommendAssetTagLink::className(), ['tag_id' => 'id'])->alias('ra')->leftJoin('ips_asset_is_not_vip av','av.asset_id = ra.asset_id')->where(['>','av.asset_id',0]);
    }
