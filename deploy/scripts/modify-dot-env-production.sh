...
sed -i "/APP_URL=/c APP_URL=https://base.818ps.com" .env
sed -i "/API_URL=/c API_URL=https://base-api.818ps.com" .env
sed -i "/ADMIN_BACKEND_DOMAIN=/c ADMIN_BACKEND_DOMAIN=base-admin.818ps.com" .env
